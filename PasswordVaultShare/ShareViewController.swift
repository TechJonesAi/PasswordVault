...
//  PasswordVaultShare
//
//  Created by Darren Jones on 18/12/2025.
...
class ShareViewController: UIViewController {
    ...
    private func presentSaveCredentialView(with url: String?) {
        let saveView = ShareSaveCredentialView(
            websiteURL: url ?? "",
    ...
    private func saveCredential(_ credential: ShareCredentialData) {
...
struct ShareSaveCredentialView: View {
    ...
    let onSave: (ShareCredentialData) -> Void
    let onCancel: () -> Void
        ...
        NavigationView {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        let credential = ShareCredentialData(
            ...
            .sheet(isPresented: $showingGenerator) {
                SharePasswordGeneratorSheet(password: $password)
            }
        }
    }
}
...
struct SharePasswordGeneratorSheet: View {
